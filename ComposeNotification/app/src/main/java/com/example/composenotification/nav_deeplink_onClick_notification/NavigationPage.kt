...
import com.example.composenotification.R
        ...
        Box(modifier = Modifier.padding(it)) {
            ...
            NavHost(navController = navController, startDestination = "Home") {
                ...
                navigation(startDestination = "HomePage", route = "Home") {
                    ...
                    composable(
                        "HomeDetailPage", deepLinks = listOf(NavDeepLink("deeplink://homeDetail"))
                    ) {
                ...
                navigation(startDestination = "ProductPage", route = "Product") {
                    ...
                    composable(
                        "ProductPage", deepLinks = listOf(NavDeepLink("deeplink://product"))
                    ) {
                    ...
                    composable(
                        "ProductDetailPage",
                        deepLinks = listOf(NavDeepLink("deeplink://productDetail"))
                    ) {
